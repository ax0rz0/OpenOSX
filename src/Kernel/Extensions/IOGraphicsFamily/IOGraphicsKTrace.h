...
#define IOG_KTRACE(args...)
#define IOG_KTRACE_NT(args...)
...
#define ABL_GT_SET_DISPLAY(args...)
#define ABL_GT_SET_BRIGHTNESS(args...)
#define ABL_GT_SET_BRIGHTNESS_PROBE(args...)
#define ABL_GT_SET_DISPLAY_POWER(args...)
#define ABL_GT_COMMITTED(args...)
#define ABL_GT_DO_UPDATE(args...)
