...
/* Linux input-event-codes.h is not part of the Darwin SDK. These values are
 * the stable evdev button ABI used by the Wayland pointer-button helper. */
#define BTN_LEFT 0x110
#define BTN_MIDDLE 0x111
#define BTN_RIGHT 0x112
