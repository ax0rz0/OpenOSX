...
// ImagePair has no header definition in this tree; the macro only needs a
// complete type to emit a no-op std::vector destructor specialization.
struct ImagePair { ImageLoader* image; unsigned int count; };
